...
namespace WarTornLands.World
{
    public class Level:IDrawProvider
    {
        ...
        {
            // Obsolete TestLevel method is obsolete because Level structure got reworked
        ...
        {
            // Just as obsolete as the TestLevel
           ...
           // boss.AddModule(new ExplodeAndLoot(new Item(0)));
